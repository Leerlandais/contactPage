        ...
        <form action="" method="post">
            <div class="md:flex items-center mt-12">
                    ...
                    <label class="font-semibold leading-none text-gray-600"
                           ...
                           id="contactNameLabel"></label>
                                <input type="text"
                                       name="contactName"
                                       id="contactName"
                                       class="leading-none text-gray-600 text-center p-3 focus:outline-none focus:border-blue-700 mt-4 border-0 bg-white bg-opacity-50 rounded"
                ...
                <div class="w-full md:w-1/2 flex flex-col md:ml-6 md:mt-0 mt-4">
                    ...
                    <input type="email"
                           class="leading-none text-gray-600 p-3 focus:outline-none focus:border-blue-700 mt-4 border-0 bg-white bg-opacity-50 rounded"
                           name="contactMail"
                           id="contactMail"
            ...
            <div>
                <div class="w-full flex flex-col mt-8">
                    <label class="font-semibold leading-none text-gray-500"
                           for="contactMess"
                           id="contactMessLabel"></label>
                    <textarea type="text"
                              class="h-40 text-base leading-none text-gray-600 p-3 focus:outline-none focus:border-blue-700 mt-4 bg-white bg-opacity-50 border-0 rounded"
                              name="contactMess"
                              id="contactMess"></textarea>
                </div>
            </div>
            <div class="flex items-center justify-center w-full">
                <button class="submitButton mt-9 font-semibold leading-none text-white py-4 px-10 bg-green-700 rounded hover:bg-green-600 focus:ring-2 focus:ring-offset-2 focus:ring-green-700 focus:outline-none"></button>
            </div>
        </form>
    </div>
</div>
